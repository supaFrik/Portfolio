...
if (typeof gsap === 'undefined') {
  console.warn('GSAP is required for the horizontal marquee. Please include GSAP.');
} else {
  ...
  if (marqueeWrap) {
    ...
    if (!track) {
      ...
      while (marqueeWrap.firstChild) {
        track.appendChild(marqueeWrap.firstChild);
      }
    ...
    const scrollingItems = gsap.utils.toArray('.marquee-track > *');
    const tl = horizontalLoop(scrollingItems, {
      repeat: -1,
      speed: 1,
      paddingRight: 40,
    });
